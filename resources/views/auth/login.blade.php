                        ...
                        <form role="form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group{{ $errors->has('username') ? ' has-danger' : '' }} mb-3">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="{{ __('Username') }}" type="username" name="username" value="{{ old('username') }}" value="username" required autofocus>
                                </div>
